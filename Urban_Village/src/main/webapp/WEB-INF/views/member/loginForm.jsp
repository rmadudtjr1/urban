...
.advertisement-text {
    ...
    box-sizing: border-box; /* 패딩을 너비에 포함시켜서 텍스트가 과도하게 확대되지 않도록 함 */
        ...
        body {
            ...
            background: linear-gradient(to bottom, #FDFCF0, #EAE0D2); /* 은은한 그라데이션 배경 */
...
<body>
    <div class="login-page">
        <div class="advertisement left-ad">
            <%-- 기존 이미지 경로는 그대로 유지 --%>
            <img src="/Urban_Village/resources/image/test.jpg" class="advertisement-slide active" alt="광고1">
            
            <img src="/Urban_Village/resources/image/test2.jpg" class="advertisement-slide" alt="광고2">
        ...
        <div class="login-container">
            ...
            <form action="/Urban_Village/member/login.do" method="post" class="login-form">
             ...
             <%-- 관리자 로그인 버튼 추가 (원래 코드에는 없었으나, 스타일 적용 예시) --%>
             <%-- 주석 처리하거나 필요에 따라 추가/수정하세요.
             <button class="admin-login-button">관리자 로그인</button>
             --%>
        </div>

        <div class="advertisement right-ad">
            <%-- 기존 이미지 경로는 그대로 유지 --%>
            <img src="/Urban_Village/resources/image/test3.jpg" class="advertisement-slide active" alt="광고3">
            <img src="/Urban_Village/resources/image/test4.jpg" class="advertisement-slide" alt="광고4">
            <%-- 필요하다면 한옥/자연 관련 광고 이미지를 사용하면 더 잘 어울립니다. --%>
        </div>
    </div>
